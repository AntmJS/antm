...
import type WEUI from '../../types/normal'
...
function objectToString(style: WEUI.IAnyObject | string): string {
...
export function mergeStyle(
  style1: WEUI.IAnyObject | string,
  style2: WEUI.IAnyObject | string,
): WEUI.IAnyObject | string {
  if (
    style1 &&

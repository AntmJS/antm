          ...
          <div className="weui-msg__text-area">
            ...
            <div className="weui-msg__custom-area">
              <ul className="weui-form-preview__list">
                <li className="weui-form-preview__item">
                  <label className="weui-form-preview__label">姓名</label>
                  <p className="weui-form-preview__value">张三</p>
                </li>
                <li className="weui-form-preview__item">
                  <label className="weui-form-preview__label">微信号</label>
                  <p className="weui-form-preview__value">zhangsan</p>
                </li>
              </ul>
            </div>
          </div>

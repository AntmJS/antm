      ...
      <div className="page button js_show">
        ...
        <div className="page__bd">
          <div className="button-sp-area">
            ...
            <a
              href="javascript:"
              className="weui-btn weui-btn_disabled weui-btn_primary"
            >
              页面主操作
            </a>
            ...
            <a
              href="javascript:"
              className="weui-btn weui-btn_default weui-btn_loading"
            >
            ...
            <a
              href="javascript:"
              className="weui-btn weui-btn_disabled weui-btn_default"
            >
              页面次要操作
            </a>
            <a href="javascript:" className="weui-btn weui-btn_warn">
              警告类操作
            </a>
            <a
              href="javascript:"
              className="weui-btn weui-btn_warn weui-btn_loading"
            >
              <span className="weui-primary-loading">
                <i className="weui-primary-loading__dot"></i>
              </span>
            ...
            <a
              href="javascript:"
              className="weui-btn weui-btn_disabled weui-btn_warn"
            >
              警告类操作
            </a>
          </div>
          ...
          <div className="button-sp-area cell">
            <a
              href="javascript:"
              className="weui-btn_cell weui-btn_cell-default"
            >
              普通行按钮
            </a>
            <a
              href="javascript:"
              className="weui-btn_cell weui-btn_cell-primary"
            >
              强调行按钮
            </a>
            <a
            ...
            <a href="javascript:" className="weui-btn_cell weui-btn_cell-warn">
              警告行按钮
            </a>
          </div>
